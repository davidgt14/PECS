...
<img src="5ROPASimagenSUBPESTANA/COMUN.png" width="300" height="85"  
     class="imagen" alt="5ROP imagCOMUN">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar5ROPASimagenCOMUN.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivo'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "5ROPASimagen/COMUN/" . $nombre;
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar5ROPASimagenCOMUN.php" method="post" enctype="multipart/form-data" style="display:none;">
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('5ROPASimagen/COMUN');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='5ROPASimagen/COMUN/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='5ROPASaudio/COMUN/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
