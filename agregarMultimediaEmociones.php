...
<img src="PECSimagen/12EMOCIONES.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaEmociones.php" method="post" enctype="multipart/form-data" style="display:none;">
