...
<img src="1NECESIDADESimagenSUBPESTANA/ACCION.png" width="300" height="85"  
     class="imagen" alt="1NECES/ACCION">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar1NECESIDADESimagenACCION.php" method="post" enctype="multipart/form-data" style="display:none;">
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar1NECESIDADESimagenACCION.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "1NECESIDADESaudio/ACCION/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
<!-- ////////////INICIO MOSTRAR CARPETA 111 ALIMENTOSimagen EN PANEL INFERIOR-->
<?php 
