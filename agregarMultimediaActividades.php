...
<img src="PECSimagen/16ACTIVIDADESENHOGAR.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaActividades.php" method="post" enctype="multipart/form-data" style="display:none;">
