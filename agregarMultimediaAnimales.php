...
<img src="PECSimagen/18ANIMALES.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaAnimales.php" method="post" enctype="multipart/form-data" style="display:none;">
