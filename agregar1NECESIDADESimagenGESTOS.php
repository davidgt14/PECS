...
<img src="1NECESIDADESimagenSUBPESTANA/GESTOS.png" width="300" height="85"  
     class="imagen" alt="1NECEimagen/GESTOS">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar1NECESIDADESimagenGESTOS.php" method="post" enctype="multipart/form-data" style="display:none;">
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar1NECESIDADESimagenGESTOS.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "1NECESIDADESaudio/GESTOS/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('1NECESIDADESimagen/GESTOS');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='1NECESIDADESimagen/GESTOS/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='1NECESIDADESaudio/GESTOS/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
