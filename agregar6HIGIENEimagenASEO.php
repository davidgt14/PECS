...
<img src="6HIGIENEimagenSUBPESTANA/ASEO.png" width="300" height="85"  
     class="imagen" alt="6HIGIENEimagen/ASEO">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar6HIGIENEimagenASEO.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivo'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "6HIGIENEimagen/ASEO/" . $nombre;
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar6HIGIENEimagenASEO.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "6HIGIENEaudio/ASEO/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
</div><!-- ////////////INICIO MOSTRAR CARPETA 666HIGIENEimagenASEO EN PANEL INFERIOR-->
<?php 
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('6HIGIENEimagen/ASEO');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='6HIGIENEimagen/ASEO/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='6HIGIENEaudio/ASEO/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
...
<!-- ////////////FIN MOSTRAR CARPETA 666HIGIENEimagenASEO EN PANEL INFERIOR-->
