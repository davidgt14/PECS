...
<img src="5ROPASimagenSUBPESTANA/ABRIGO.png" width="300" height="85"  
     class="imagen" alt="5ROP Imagen/ABRIGO">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar5ROPASimagenABRIGO.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivo'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "5ROPASimagen/ABRIGO/" . $nombre;
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar5ROPASimagenABRIGO.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "5ROPASaudio/ABRIGO/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('5ROPASimagen/ABRIGO');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='5ROPASimagen/ABRIGO/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='5ROPASaudio/ABRIGO/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
