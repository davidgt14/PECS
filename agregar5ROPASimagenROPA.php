...
<img src="5ROPASimagenSUBPESTANA/FORMAL.png" width="300" height="85"  
     class="imagen" alt="5ROPASimagen/ROPA">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar5ROPASimagenROPA.php" method="post" enctype="multipart/form-data" style="display:none;">
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar5ROPASimagenROPA.php" method="post" enctype="multipart/form-data" style="display:none;">
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('5ROPASimagen/ROPA');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='5ROPASimagen/ROPA/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='5ROPASaudio/ROPA/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
