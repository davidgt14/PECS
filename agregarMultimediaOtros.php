...
<img src="PECSimagen/otros.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaOtros.php" method="post" enctype="multipart/form-data" style="display:none;">
