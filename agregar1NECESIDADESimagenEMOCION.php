...
<img src="1NECESIDADESimagenSUBPESTANA/EMOCION.png" width="300" height="85"  
     class="imagen" alt="1NECimagen/EMOCION">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar1NECESIDADESimagenEMOCION.php" method="post" enctype="multipart/form-data" style="display:none;">
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar1NECESIDADESimagenEMOCION.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "1NECESIDADESaudio/EMOCION/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('1NECESIDADESimagen/EMOCION');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='1NECESIDADESimagen/EMOCION/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='1NECESIDADESaudio/EMOCION/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
