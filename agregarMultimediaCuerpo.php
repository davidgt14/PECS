...
<img src="PECSimagen/14CUERPO.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaCuerpo.php" method="post" enctype="multipart/form-data" style="display:none;">
