...
<img src="PECSimagen/17JUGUETES.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaJuguetes.php" method="post" enctype="multipart/form-data" style="display:none;">
