...
<img src="4ACTIVIDADESimagenSUBPESTANA/HOGAR.png" width="300" height="85"  
     class="imagen" alt="4ACTIVIDADESimagen/HOGAR">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar4ACTIVIDADESimagenHOGAR.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivo'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "4ACTIVIDADESimagen/HOGAR/" . $nombre;
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar4ACTIVIDADESimagenHOGAR.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "4ACTIVIDADESaudio/HOGAR/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('4ACTIVIDADESimagen/HOGAR');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='4ACTIVIDADESimagen/HOGAR/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='4ACTIVIDADESaudio/HOGAR/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
