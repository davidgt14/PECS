...
<img src="PECSimagen/11FRUTAS.png" width="300" height="77"  
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregarMultimediaFrutas.php" method="post" enctype="multipart/form-data" style="display:none;">
