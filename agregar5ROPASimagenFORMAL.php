...
<img src="5ROPASimagenSUBPESTANA/FORMAL.png" width="300" height="85"  
     class="imagen" alt="5ROPASimagen/FORMAL">
...
<td style="background-color: green;">
    ...
    <form id="formulario" action="agregar5ROPASimagenFORMAL.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivo'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "5ROPASimagen/FORMAL/" . $nombre;
...
<td style="background-color: green;">
    ...
    <form id="formularioAudio" action="agregar5ROPASimagenFORMAL.php" method="post" enctype="multipart/form-data" style="display:none;">
...
if(isset($_FILES['archivoAudio'])){
    ...
    $nombre = $archivo['name'];
    $ruta = "5ROPASaudio/FORMAL/" . $nombre;
    move_uploaded_file($archivo['tmp_name'], $ruta);
    //echo "I";    //echo $ruta;   
} else { //echo "";
}
...
//MATRICIAR A LA CARPETA ALIMENTO
   $ALIMENTOimagen = scandir('5ROPASimagen/FORMAL');
   ...
   foreach ($ALIMENTOimagen as $imagenALIMENTOimagen) {
      ...
      $RutaALIMENTOimagen[$i]='5ROPASimagen/FORMAL/'.$imagenALIMENTOimagen;
         $RutaALIMENTOaudio[$i]='5ROPASaudio/FORMAL/'.$imagenALIMENTOimagen; //echo $RutaImagen[$i];
